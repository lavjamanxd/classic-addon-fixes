...
do
	...
	opt:SetScript(
		...
		function(self)
			...
			local fontBox = CreateFrame("Frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
			...
			local settBox = CreateFrame("Frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
